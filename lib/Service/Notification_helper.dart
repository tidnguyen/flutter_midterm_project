...
class NotificationHelper {
 ...
 static Future<void> scheduledNotification(String title, String body, DateTime selectedDateTime) async {
  TZDateTime selectedTZDateTime = tz.TZDateTime.from(selectedDateTime, tz.local);
